    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
                ...
                <h4 class="modal-title test-text" id="myModalLabel">Masukan Pilihan</h4>
            </div>
                ...
                <label for="exampleInputEmail1 " class="test-text">Pilih Warna</label>
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1" class="test-text">Size</label>
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1" class="test-text">Quantity</label>
