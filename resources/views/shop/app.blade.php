                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="{{url('cart')}}"><strong>Subtotal: </strong>
                                    <div>
                                        Rp.{{ Cart::subtotal() }}
                                    </div>
                                </a>
                    ...
                    @else
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true" v-pre class="active">
