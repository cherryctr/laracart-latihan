...
@section('title')
Jual Makanan dan Minuman Terlengkap di Indonesia
@endsection
@section('content')
	<!-- banner -->
	...
	<div class="ads-grid">
		<div class="container">
			@if($message = Session::get('checkoutsukses'))
			...
			@endif
			<!-- tittle heading -->
			<h3 class="tittle-w3l">Our Top Products {{ url('') }}
			...
			<div class="side-bar col-md-3">
				...
				<div class="left-side">
					...
					<ul>
						<li>
							<a href="" class="nav-stylehead">Vegetarian</a>
						</li>
					</ul>
				</div>
				<!-- //food preference -->
				...
				<div class="deal-leftmk left-side">
					...
					<div class="special-sec1">
						<div class="col-xs-4 img-deals">
							<img src="{{url('shop/images')}}/d2.jpg" alt="">
						</div>
						...
						<div class="col-md-4 product-men">
							<div class="men-pro-item simpleCart_shelfItem">
								<div class="men-thumb-item">
									<img src="{{url('shop/images/')}}/{{$r->prdthumb}}" alt="">
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="{{ url('beli')}}/{{$r->prdslug}}" class="link-product-add-cart">Quick View</a>
										</div>
									</div>
								...
								<div class="item-info-product ">
									<h4>
										<a href="single.html">{{$r->prdname}}, {{$r->prdsize}}</a>
									</h4>
									<div class="info-product-price">
										<span class="item_price">{{$r->prdprice}}</span>
