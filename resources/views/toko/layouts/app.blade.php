...
<head>
	...
	<meta name="keywords" content="Laravel E-commerce" />
	<script>
	...
	<!--//pop-up-box-->
	<!-- price range -->
	<link rel="stylesheet" type="text/css" href="{{url('shop')}}/css/jquery-ui1.css">
	<!-- flexslider -->
	<link rel="stylesheet" href="{{url('shop')}}/css/flexslider.css" type="text/css" media="screen" />
	<!-- fonts -->
...
<body>
			...
			<div class="col-md-4 logo_agile">
				<h1>
					<a href="index.html">
						<span>G</span>rocery
						<span>S</span>hoppy
						<img src="{{url('shop')}}/images/logo2.png" alt=" ">
					</a>
				</h1>
			</div>
			<!-- header-bot -->
	...
	<!-- js-files -->
	<!-- jquery -->
	<script src="{{url('shop')}}/js/jquery-2.1.4.min.js"></script>
	<!-- //jquery -->

	<!-- popup modal (for signin & signup)-->
	<script src="{{url('shop')}}/js/jquery.magnific-popup.js"></script>
	<script>
	...
	<!-- smoothscroll -->
	<script src="{{url('shop')}}/js/SmoothScroll.min.js"></script>
	<!-- //smoothscroll -->

	<!-- start-smooth-scrolling -->
	<script src="{{url('shop')}}/js/move-top.js"></script>
	<script src="{{url('shop')}}/js/easing.js"></script>
	<script>
	...
	<!-- imagezoom -->
	<script src="{{url('shop')}}/js/imagezoom.js"></script>
	<!-- //imagezoom -->

	<!-- FlexSlider -->
	<script src="{{url('shop')}}/js/jquery.flexslider.js"></script>
	<script>
	...
	<script src="{{url('shop')}}/js/jquery.flexisel.js"></script>
	<script>
		$(window).load(function () {
